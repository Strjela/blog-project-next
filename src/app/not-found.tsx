  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-indigo-500 bg-fixed bg-cover bg-bottom error-bg">
      <div className="container mx-auto">
        <div className="flex flex-col items-center justify-center text-gray-50 text-center -mt-52">
          ...
          <Link href="/">
            <button className="bg-green-400 px-5 py-3 text-sm shadow-sm font-medium tracking-wider text-gray-50 rounded-full hover:shadow-lg">
              Go to Home
            </button>
          </Link>
        </div>
