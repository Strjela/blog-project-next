    ...
    <section className="relative flex flex-col justify-start mt-12 overflow-hidden py-8 px-4 mx-auto  lg:py-16 lg:px-6 h-[50vh] md:h-[70vh] lg:h-[90vh]">
      <div className="absolute inset-0 z-[1]">
        <Image
          ...
          quality={100}
          priority
          className="object-cover w-full h-[60vh] lg:h-[100vh]"
        />
      </div>

      <div className="absolute inset-0 z-[2] bg-gradient-to-b from-white via-transparent  to-transparent " />

      <div className="relative z-10 mx-auto max-w-screen-md sm:text-center ">
